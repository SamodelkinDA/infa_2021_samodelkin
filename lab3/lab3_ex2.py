"""Эта программа рисует красивые картинки.
   На данный момент она может нарисовать далеких птиц, плавник рыбы
"""
...
def fishs_fin(fin_size, fin_tetta, fin_flip_bool):
    ...
    polygon(fish_fin_surface, (0,0,0), massive_fish_fin, 1)
...
def draw_fish(x_fish, y_fish, size_of_fish):
    ...
    fish_surface.blit(fishs_fin(200, 180, 1), (0, 0))
    fish_surface.blit(fishs_eye(80), (0, 0))


    screen.blit(pygame.transform.scale(
        fish_surface, (size_of_fish, size_of_fish)), 
        (x_fish - 100, y_fish - 100)
    )
    return 
